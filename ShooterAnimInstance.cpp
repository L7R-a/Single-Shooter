...
void  UShooterAnimInstance::UpdateAnimationProperties(float DeltaTime)
{
	...
	if (ShooterCharacter)
	{
		...
		// Get the lateral (X and Y) speed of the character from velocity
...
void UShooterAnimInstance::TurnInPlace()
{
	...
	if (Speed > 0 || bIsInAir)
	{
		// Do not want to turn if the character is moving
		RootYawOffset = 0.f;
	...
	else
	{
		...
		if (Turning > 0)
		{
			...
			// If RootYawOffset > 0, then we turn left. Otherwise we turn right
